...
#if defined(JOYSTICK_VERT_PIN)
#define JOYSTICK_VERT_ANALOG_INPUTS 1
#define JOYSTICK_VERT_INDEX EXT0_ANALOG_INPUTS+EXT1_ANALOG_INPUTS+EXT2_ANALOG_INPUTS+EXT3_ANALOG_INPUTS+EXT4_ANALOG_INPUTS+EXT5_ANALOG_INPUTS+BED_ANALOG_INPUTS
#define JOYSTICK_VERT_ANALOG_CHANNEL ACCOMMA6 JOYSTICK_VERT_PIN
#define ACCOMMA7 ,
#else
#define ACCOMMA7 ACCOMMA6
#define JOYSTICK_VERT_ANALOG_INPUTS 0
#define JOYSTICK_VERT_INDEX 
#define JOYSTICK_VERT_ANALOG_CHANNEL
#endif


#if defined(JOYSTICK_HORI_PIN)
#define JOYSTICK_HORI_ANALOG_INPUTS 1
#define JOYSTICK_HORI_INDEX EXT0_ANALOG_INPUTS+EXT1_ANALOG_INPUTS+EXT2_ANALOG_INPUTS+EXT3_ANALOG_INPUTS+EXT4_ANALOG_INPUTS+EXT5_ANALOG_INPUTS+BED_ANALOG_INPUTS+JOYSTICK_VERT_ANALOG_INPUTS
#define JOYSTICK_HORI_ANALOG_CHANNEL ACCOMMA7 JOYSTICK_HORI_PIN
#define ACCOMMA8 ,
#else
#define ACCOMMA8 ACCOMMA7
#define JOYSTICK_HORI_ANALOG_INPUTS 0
#define JOYSTICK_HORI_INDEX 
#define JOYSTICK_HORI_ANALOG_CHANNEL
#endif
...
#define ANALOG_INPUTS (EXT0_ANALOG_INPUTS+EXT1_ANALOG_INPUTS+EXT2_ANALOG_INPUTS+EXT3_ANALOG_INPUTS+EXT4_ANALOG_INPUTS+EXT5_ANALOG_INPUTS+BED_ANALOG_INPUTS+JOYSTICK_VERT_ANALOG_INPUTS+JOYSTICK_HORI_ANALOG_INPUTS)
#if ANALOG_INPUTS>0
/** Channels are the MUX-part of ADMUX register */
#define  ANALOG_INPUT_CHANNELS {EXT0_ANALOG_CHANNEL EXT1_ANALOG_CHANNEL EXT2_ANALOG_CHANNEL EXT3_ANALOG_CHANNEL EXT4_ANALOG_CHANNEL EXT5_ANALOG_CHANNEL BED_ANALOG_CHANNEL  JOYSTICK_VERT_ANALOG_CHANNEL  JOYSTICK_HORI_ANALOG_CHANNEL}
#endif
